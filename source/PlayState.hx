		...
		switch (curStage)
		{
			...
			case 'limo': //Week 4
				...
				if(!ClientPrefs.lowQuality) {
					...
					for (i in 0...5)
					{
						var dancer:BackgroundDancerVitas = new BackgroundDancer((370 * i) + 130, bgLimo.y - 400);
						dancer.scrollFactor.set(0.4, 0.4);
						grpLimoDancers.add(dancer);
					}
				...
				if(!ClientPrefs.lowQuality) {
					...
					for (i in 0...5)
					{
						var dancer:BackgroundDancerThank = new BackgroundDancer((370 * i) + 130, bgLimo.y - 400);
						dancer.scrollFactor.set(0.4, 0.4);
						grpLimoDancers.add(dancer);
					}
